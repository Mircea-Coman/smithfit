"""
    ...
    ===========
      ...
      -----------
        ...
        Python implementation of the NLQFIT6 algorithm. The input parameter
        trmode specifies the resonance type (normally "transmission" or
        "absorption").
...
def initialfit(F, S, N, Fres, Qseed):
    ...
    """
      ...
      ----------------------------
        ...
        NLQFIT6, NLQFIT7 and NLQFIT8 Step (1).

          Linear least squares Q-factor fit.
        ...
        Input parameters:
          ...
          S     - List of complex S-parameter data to be fitted.
          N     - Number of points.
...
def optimisefit6(F, S, N, Fseed, sv, loop_plan, Tol, quiet):
    """
       ...
       ------------------------------------------
         ...
         Input parameters:
           ...
           sv        - Initial solution (numpy vector or a list) found
                       with InitialFit.
           loop_plan - String of characters which defines order of steps used by the fitting process e.g. 'fwfwc':
           ...
           Tol   - Criterion for the convergence test.
                   ...
                   for transmission.
           quiet - Boolean flag controlling output of information to the console.

         Output (MAT58 eqn. 22)
             list of fitted parameters: [m1, m2, m4, m4, QL, FL]
    """
    ...
    for op in loop_plan:
        ...
        if not quiet: print()
    return [m1,m2,m3,m4,m5,m5*Flwst/m6], weighting_ratio, number_iterations, RMS_Error
